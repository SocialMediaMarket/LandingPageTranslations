    ...
    'main': {
      ...
      metaTags: [
        ...
        {property: 'og:title', content: 'SocialMedia.Market - SOFT CAP ATTEINT! Vente de token EN COURS!'},
        {
          ...
          'Résoudre les problèmes majeurs en marketing des influenceurs, SocialMedia.Market créera de nouvelles ' +
          'opportunités pour la monétisation du contenu, l\'engagement communautaire et l\'exposition publique.'
        },
        {property: 'og:url', content: 'https://socialmedia.market/fr'},
        {property: 'og:site_name', content: 'SocialMedia.Market'},
        {property: 'og:image', content: 'https://socialmedia.market/assets/img/smm_preview.jpg'},
        {property: 'og:image:width', content: '1200'},
        {property: 'og:image:height', content: '1200'},
      ...
      metaTags: [
        ...
        {property: 'og:title', content: 'SocialMedia.Market - SOFT CAP ERREICHT! Token Verkauf LIVE!'},
        {
          ...
          content: 'Der erste dezentralisierte Marktplatz verbindet Social-Media-Blogger und Werbetreibende. ' +
                   'Lösung von Marketingproblemen von großen Influencer SocialMedia.Market ist die neue Möglichkeiten ' +
                   'für die Monetarisierung von Inhalten, das Engagement von Communities und die Präsenz von Zielgruppen schaffen.'
        },
      ...
      metaTags: [
        ...
        {property: 'og:title', content: 'SocialMedia.Market - CAP MINIMO ALCANZADO! Venta de Tokens ACTIVA!'},
        {
          ...
          content: 'El primer mercado descentralizado conectando medios sociales, bloggers y publicistas. ' +
                   'Solventando los mayores problemas de publicidad SocialMedia.Market creará nuevas oportunidades ' +
                   'para monetizar su contenido, la interacción de la comunidad y la expocisión de audiencias.'
        },
      ...
      metaTags: [
        ...
        {property: 'og:title', content: 'SocialMedia.Market - 소프트캡 달성! 토큰 세일 라이브!'},
        {
          ...
          content: '소셜 미디어 블로거와 광고주를 연결하는 최초의 탈중앙화 시장. 영향을 미치는 주요 마케팅 문제 해결 ' +
                   'SocialMedia.Market은 콘텐츠의 수익 창출, 커뮤니티 참여 및 구독자에 대한 노출을 위한 새로운 기회를 창조합니다. ' 
        },
      ...
      metaTags: [
        ...
        {property: 'og:title', content: 'SocialMedia.Market - GIỚI HẠN MỀM ĐÃ ĐẠT! Bán Token đang hoạt động!'},
        {
          ...
          content: 'Sàn thương mại phân cấp đầu tiên kết nối các bloggers mạng xã hội với các nhà quảng cáo. ' +
                   'Giải quyết các vấn đề chính về marketing sửu dụng người có tầm ảnh hưởng, SocialMedia.Market ' +
                   'sẽ tạo ra những cơ hội mới cho việc tiền tệ hóa nội dung, gắn kết cộng đồng và tiếp cận khán giả.'
        },
        {property: 'og:url', content: 'https://socialmedia.market/vi'},
        {property: 'og:site_name', content: 'SocialMedia.Market'},
        {property: 'og:image', content: 'https://socialmedia.market/assets/img/smm_preview.jpg'},
        {property: 'og:image:width', content: '1200'},
        {property: 'og:image:height', content: '1200'},
      ...
      metaTags: [
        ...
        {property: 'og:title', content: 'SocialMedia.Market - SOFT CAP ALCANÇADO! A Venda de Token Ativa!'},
        {
          ...
          content: 'O primeiro mercado descentralizado conectado de blogueiros de redes sociais e anunciantes. ' +
                   'Resolvendo os principais problemas do marketing de influenciadores,  SocialMedia.Market criará novas ' +
                   'oportunidades para a monetização de conteúdo, o envolvimento da comunidade e a exposição do público.'
        },
        {property: 'og:url', content: 'https://socialmedia.market/pt'},
        {property: 'og:site_name', content: 'SocialMedia.Market'},
        {property: 'og:image', content: 'https://socialmedia.market/assets/img/smm_preview.jpg'},
        {property: 'og:image:width', content: '1200'},
        {property: 'og:image:height', content: '1200'},
